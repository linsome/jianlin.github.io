...
**Finding:**
{% include figure.liquid path="assets/img/k-shot_vs_accuracy.png" title="K-shot vs Accuracy" class="img-fluid rounded z-depth-1" style="max-width: 400px; margin: auto; display: block;" %}
